...
function Settle() {
  ...
  if (!online || offlineData) return <Layout><Link to={`/groups/${id}`} className="back">← {group.name}</Link><p className="offline-banner" role="status">Settlements are online-only. Reconnect to settle up.</p></Layout>;
